...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glTranslatef(pos_camX, pos_camY, pos_camZ);
		...
		glPushMatrix(); 
			...
			prisma(t_Ajedrez2.GLindex, t_madera.GLindex); //Estamos asignando la textura ladrillo
		glPopMatrix();
		...
		glPushMatrix();
			...
			prisma2(t_madera.GLindex, t_metal01.GLindex); //Estamos asignando la textura madera
		glPopMatrix();
